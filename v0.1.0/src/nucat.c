...
// Lets work through the logic of this:
//  - We need to iterate through our buffer[4096], char by char
//  - We need to find every \n, for this signifies a newline
//  - Prepend each line with line number (one-indexed, not zero)
